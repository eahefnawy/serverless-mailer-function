...
### Quick Usage
After installation, set your env variables in serverless.yml

```
provider:
  name: aws
  environment:
      # replace these env variables with your your values
      EMAIL_SERVICE: Gmail
...
Then invoke the `mailer` function by running `serverless invoke -f mailer -p event.json`
